...
export default function ConcertCard({
  ...
  const getStatusColor = () => {
    ...
    if (concert.availableSeats < concert.totalSeats * 0.2)
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex-1 border-b-1 pb-4 border-[#C2C2C2]">
          <h3 className="text-xl font-bold text-[#1692EC] mb-2">
            {concert.name}
          </h3>
          <span
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
          ...
          <div className="text-sm">
            ...
            onClick={() => onDelete(concert.id)}
            disabled={isDeleting}
            className={`flex items-center justify-center w-40 py-2 px-4 rounded font-medium transition-colors ${
              isDeleting
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            ...
            style={{
              width: `${(concert.reservedSeats / concert.totalSeats) * 100}%`,
            }}
          />
        </div>
      </div>
